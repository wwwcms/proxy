export default defineEventHandler(async event => {
  ...
  try {
    ...
    const videoList = video.map((i, l) => {
      return i.map((j, k) => {
        const v = j[1]?.replace(/sf16-sg.larksuitecdn.com|lf16-secsdk.bitssec.com|lf16-box.feishucdn.com|sf19-sg.larksuitecdn.com|sf21-sg.larksuitecdn.com/, 'sf-gs-frontend-sg.fanchenstatic.com')
